...
try {
    ...
    console.log(treeFuncs.removeGroupHierarchy(11));

    console.log("\nHere you should expect to get 'false':");
    console.log(treeFuncs.removeGroupHierarchy(11));
    console.log(treeFuncs.removeGroupHierarchy(12));
    console.log(treeFuncs.removeGroupHierarchy(13));
    console.log(treeFuncs.removeGroupHierarchy(14));
